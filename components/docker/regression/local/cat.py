...
@dc.param(
    String(
        key="evalMetric",
        default="MAE",
        help="The metric used for overfitting detection and best model selection. MAE,MAPE,RMSE,Poisson,SMAPE,R2,MSLE,MedianAbsoluteError",
    )
)
...
def catBoostRegression(context):
    # 从 Context 中获取相关数据
    args = context.args
